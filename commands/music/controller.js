...
module.exports = {
    ...
    async execute({ inter, client }) { 
      ...
      if (Channel.type !== 0) return inter.reply({ content: `**Dikka!** Du musst des wenn schon in nen richtigen Textchannel schicken.`, ephemeral: true},
          console.log(inter.member.user.tag + ' did not send the command into a text channel'));
      ...
      const embed = new EmbedBuilder()
       ...
       .setColor('#36393e')
       .setFooter({ text: `Persönliche Steuerung von **${inter.member.user.tag}**`, iconURL: inter.member.avatarURL({ dynamic: true })})


         inter.reply({ content: `Ok hier im **${Channel}** kannst du mich steuern ✅`, ephemeral: true})
